...
/*void draw(){
     ...
     //estas dos funciones dibujan dos conjuntos de figuras
     //deben de estar en el metodo draw() o como al que dibuje en general
     dibujarGrupoFiguras(0, 50);
     dibujarGrupoFiguras(1, 200);
}*/
...
/*void establecerGruposFiguras(){
     ...
     for(int i = 0; i < 2; i++){
          ...
          seguirBuscandoRandom = true;
          int colorRandom = (int)(random(8));
          Color colorEscogido;
          switch(colorRandom){
               case 0:   colorEscogido = Color.BLACK;
                         break;
               case 1:   colorEscogido = Color.BLUE;
                         break;
               case 2:   colorEscogido = Color.GRAY;
                         break;
               case 3:   colorEscogido = Color.GREEN;
                         break;
               case 4:   colorEscogido = Color.MAGENTA;
                         break;
               case 5:   colorEscogido = Color.ORANGE;
                         break;
               case 6:   colorEscogido = Color.PINK;
                         break;
               default:  colorEscogido = Color.WHITE;
                         break;
          }
